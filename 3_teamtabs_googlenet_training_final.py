"""
GoogleNet(V1)training, aux layers removed
@author: Team Tabs
"""
...
###Delete original output-dense layers of size 1000
for i in range(6):
    model.layers.pop()
 
 
#######################################
##Add output-dense layers of size 4
...
#Subtract Channelwise mean (obtained from the original imagenet model)
...
#Save output weights for making predictions
model.save_weights('gnet_noaux_nofreeze_lr1e3_10epochs_lr1e4_2epochs.h5')
